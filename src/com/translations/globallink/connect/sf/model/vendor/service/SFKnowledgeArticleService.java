...
public interface SFKnowledgeArticleService {
     ...
     * @param articleType
     *            Type of SF article
     * @return List of SFArticle populated with source Knowledge Article Ids and Article Types that are ready for translation for provided targetSFLocale code.
     * @throws Exception
     */
     ...
     * @return List of SFArticleField populated with field details for this Knowledge Article Type
     * @throws Exception
     */
    public List<SFArticleField> getFieldsForArticleType(String articleTypeName) throws Exception;
    
    /**
     * @return List of SFLocale populated with all the configured locale in SalesForce
     * @throws Exception
     */
