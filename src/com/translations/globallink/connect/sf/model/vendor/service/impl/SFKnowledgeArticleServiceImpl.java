...
public class SFKnowledgeArticleServiceImpl implements SFKnowledgeArticleService {
    ...
    public List<SFArticle> getReadyArticleIdsForTranslation(String targetSFLocale, String articleType) throws Exception {
		...
		String queueId = SFUtility.getQueueId(connectionConfig.getQueueName(), accessToken, connectionConfig.getUrl());
		List<String> processInstanceIdList = SFUtility.getProcessInstanceIds(queueId, accessToken, connectionConfig.getUrl() );
		...
		return SFUtility.getKnowLedgeArticlesTranslatedVersions(targetInstaceIdList, articleType, accessToken, connectionConfig.getUrl(), targetSFLocale);
    }
    ...
    public void importTranslatedArticle(SFArticle sourceArticle, String targetSFLocale, InputStream stream) throws Exception {
    	String accessToken = SFUtility.getAccessTokenFromSF();
    	SFUtility.insertArticleIntoSF(sourceArticle, Utility.GenerateJsonBody(),accessToken,connectionConfig.getUrl());
